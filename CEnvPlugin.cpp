...
//	内部定数
const float AXIAL_INCLINATION = RS2ToRadian(23.44f);	//	地軸の傾き
const float DAYS_PER_YEAR = 365.2425f;					//	年当たり平均日数
const float REV_PER_DAY = 2.0f*RS2_PI/DAYS_PER_YEAR;	//	1 日当たり公転角度
const float ROT_PER_DAY = 2.0f*RS2_PI+REV_PER_DAY;		//	1 日当たり自転角度
